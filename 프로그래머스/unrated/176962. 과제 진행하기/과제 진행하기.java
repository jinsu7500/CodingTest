...
class Solution {
    ...
    public String[] solution(String[][] plans) {
        ...
        {                
            ...
            // {
            //     int curtime = PlanLS.peek().start;                      //신규과제 시작시간
            //     int remainTime = (startTime + playTime) - curtime;      //기존과제 남은시간
                
            //     //스택에 넣을 해쉬맵
            //     HashMap<String,Integer> stopMap = new HashMap<>();
            //     //남은시간 저장해서 스택에 넣기
            //     stopMap.put(name, remainTime);
                
            //     //임시저장용 스택 
            //     stopStack.push(stopMap);
            // }
            // //현재진행중인 과제 완료시 
            // else
            // {
